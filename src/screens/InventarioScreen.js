...
const InventarioScreen = () => {
  ...
  const [filteredInsumos, setFilteredInsumos] = useState([]); // Para el buscador
  ...
  useEffect(() => {
    const subInsumos = firestore()
      ...
      .onSnapshot(snap => {
        ...
        setInsumos(data);
        setFilteredInsumos(data); // Inicializamos los filtrados
        setLoading(false);
      }, error => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* MODAL HISTORIAL (Mantiene tu lógica) */}
